...
type LoopNodeRead struct {
	...
	EvaluationFindings []loopevaluation.Finding `json:"evaluation_findings,omitempty"`
	EvaluationEvidence []string                 `json:"evaluation_evidence,omitempty"`

	ApprovalID              string `json:"approval_id,omitempty"`
	ApprovalState           string `json:"approval_state,omitempty"`
	ApprovalRequestedFromID string `json:"approval_requested_from_id,omitempty"`
